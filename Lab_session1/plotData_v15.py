...
if __name__ == '__main__':
    ...
    ## 2D plotting example
    img1 = cv2.cvtColor(cv2.imread("D:/Dev_Space/python/Practice1/Image1.jpg"), cv2.COLOR_BGR2RGB)
    img2 = cv2.cvtColor(cv2.imread("D:/Dev_Space/python/Practice1/Image2.jpg"), cv2.COLOR_BGR2RGB)
